...
#### Target Accounts (Default Accounts)
...
### Automating Resets
Script: https://github.com/0xNayel/OSWE-AWAE-Notes/blob/main/openCRX/xxe_lfd.py#L20C21-L20C21
...
```
##### External `wrapper.dtd` File
```xml
<!ENTITY wrapper "%start;%file;%end;">
```

#### `file:///` directory listing (Discover sensitive files on the target system)
...
**Exploitation Script:** https://github.com/0xNayel/OSWE-AWAE-Notes/blob/main/openCRX/xxe_lfd.py
...
```
If everything works, we'll find a new file named `test.txt` in the database's working directory. 
...
We can call our `systemprop` function again to receive the working directory.
...
**Webshell:** https://github.com/0xNayel/OSWE-AWAE-Notes/blob/main/openCRX/cmdjsp.jsp
