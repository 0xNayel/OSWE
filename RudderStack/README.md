...
Final version: [routes_clean.txt](https://github.com/0xNayel/OSWE-AWAE-Notes/blob/main/RudderStack/routes_clean.txt)
...
1703  }
```
#### Confirming the SQL Injection — Spotting the Vulnerable Code Snippet 
...
#### Writing to the File System using pgsql `COPY` Function 
...
#### Execute System Commands using pgsql `COPY` Function 
...
**Automation script:** [rce_script_noWAFbypass.py](https://github.com/0xNayel/OSWE-AWAE-Notes/blob/main/RudderStack/rce_script_noWAFbypass.py)
...
```
**Automation Script:** [rce_script_WAFbypass.py](https://github.com/0xNayel/OSWE-AWAE-Notes/blob/main/RudderStack/rce_script_WAFbypass.py)
